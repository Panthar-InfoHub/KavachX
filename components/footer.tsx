      ...
      <div className="max-w-8xl mx-auto w-full px-6 md:px-12 flex flex-col md:flex-row justify-between items-start gap-12 mb-12 z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-16 md:gap-32 w-full md:w-auto items-start">
          ...
          <div className="flex gap-6 sm:mt-1">
            <Link href="https://x.com/KavachX" target="_blank" className="text-gray-100 hover:text-white transition-colors">
              <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </Link>
            <Link href="https://www.instagram.com/kavachx/" target="_blank" className="text-gray-100 hover:text-white transition-colors">
            ...
            <Link href="https://www.linkedin.com/company/suraksha-kawach1/?viewAsMember=true" target="_blank" className="text-gray-100 hover:text-white transition-colors">
