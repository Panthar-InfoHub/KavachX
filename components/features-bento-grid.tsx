    ...
    <section className="w-full bg-[#fafafa] py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 auto-rows-auto">
          ...
          <div className="md:col-span-4 md:row-span-2 bg-white rounded-3xl px-7 pt-7 flex flex-col justify-between border border-gray-100 shadow-sm min-h-[450px] overflow-hidden">
            <div>
          ...
          <div className="md:col-span-4 bg-white rounded-3xl px-7 pt-7 flex flex-col justify-between border border-gray-100 shadow-sm min-h-[240px] overflow-hidden">
            <div>
