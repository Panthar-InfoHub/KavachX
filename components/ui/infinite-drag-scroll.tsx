      ...
      <div className="h-dvh overflow-hidden relative">
        ...
        >
          ...
          >
            ...
            <div className="relative w-14 h-14">
              ...
              <div className="absolute inset-0 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-white">
                  <path
                    d="M9 11V6a1.5 1.5 0 0 1 3 0v5M9 11a1.5 1.5 0 0 0-3 0v2M9 11a1.5 1.5 0 0 1 3 0m0 0V9a1.5 1.5 0 0 1 3 0v4m0 0a1.5 1.5 0 0 1 3 0v2a6 6 0 0 1-6 6H11a7 7 0 0 1-5-2.1L4 17"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
            ...
            {/* Label */}
            <div className="px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-lg">
              <p className="text-white text-xs font-semibold tracking-wide whitespace-nowrap">
                Hold &amp; Drag to explore achievements
              </p>
            </div>
          </motion.div>
        </motion.div>
        <motion.div className="h-dvh overflow-hidden">
          <motion.div
            className={cn(
              "grid h-fit w-fit cursor-grab grid-cols-[repeat(2,1fr)] bg-[#030303] active:cursor-grabbing will-change-transform",
              className,
            )}
            drag
            dragMomentum={true}
